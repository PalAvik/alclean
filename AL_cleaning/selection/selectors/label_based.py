...
from AL_cleaning.training_scripts.dataloader import get_train_dataloader, get_val_dataloader
from AL_cleaning.training_scripts.trainers.model_trainer_base import ModelTrainer
from AL_cleaning.evaluation.metrics import cross_entropy, max_prediction_error
from AL_cleaning.selection.selectors.base import SampleSelector
from AL_cleaning.training_scripts.PyTorchImageClassification.optim import create_optimizer
...
class PosteriorBasedSelector(LabelDistributionBasedSampler):
    ...
    def update_beliefs(self, iteration_id: int, *args: Any, **kwargs: Any) -> None:
        ...
        learning_rate = 1e-6  # 1e-6 for vanilla
        num_epochs = 10
