...
from AL_cleaning.training_scripts.architectures.ema import EMA
from AL_cleaning.training_scripts.collect_embeddings import get_all_embeddings
from AL_cleaning.training_scripts.graph.classifier import GraphClassifier
from AL_cleaning.training_scripts.loss import CrossEntropyLoss, consistency_loss
from AL_cleaning.training_scripts.trainers.model_trainer_base import IndexContainer, Loss, ModelTrainer
from AL_cleaning.training_scripts.scheduler import ForgetRateScheduler
from AL_cleaning.training_scripts.utils import create_model
from AL_cleaning.utils.generics import find_union_set_torch, map_to_device
        ...
        for indices, images, labels in dataloader:
            ...
            if is_train:
                ...
                self.joint_metric_tracker.append_batch_aggregate(epoch=epoch,
                                                                 ...
                                                                 dropped_cases=indices[selected_ind[0].exclude.cpu()],
                                                                 indices=indices)
